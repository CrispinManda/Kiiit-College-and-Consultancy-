            ...
            <div class="container">
                <div class="row top-cont-grid align-items-center">
                    <div class="col-lg-6 left-img pr-lg-4">
                        <img src="https://i.pinimg.com/564x/ac/54/60/ac5460d34f968dc2d91969fa2db59c13.jpg" alt="" class="img-responsive img-fluid" />
                    </div>
                    <div class="col-lg-6 text-6-info mb-lg-0 mb-4 pl-lg-5">
                        ...
                        <a href="blog-single.html" class="btn button-style mt-sm-5 mt-4">Read More<i
            ...
            <div class="w3-stats">
                <div class="row text-center">
                    <div class="col-md-3 col-6">
                        <div class="counter">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/stats1.png" alt="" />
                    ...
                    <div class="col-md-3 col-6">
                        <div class="counter">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/stats2.png" alt="" />
                    ...
                    <div class="col-md-3 col-6 mt-md-0 mt-4">
                        <div class="counter">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/stats3.png" alt="" />
                    ...
                    <div class="col-md-3 col-6 mt-md-0 mt-4">
                        <div class="counter">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/stats4.png" alt="" />
                ...
                <div class="row mb-lg-2">
                    ...
                    <div class="col-lg-6 left-wthree-img-video text-righ pr-lg-5 mt-lg-0 mt-5">
                        <div class="position-relative text-center">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/jofu.jpg" alt="" class="img-fluid radius-image-full">
                            <a href="#small-dialog"
                            ...
                            <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
                                <iframe
                                    src="https://www.youtube.com/watch?v=u9eVowyoOZA"
                ...
                <div id="owl-demo1" class="owl-carousel owl-theme mt-5">
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="testi-des">
                                    <div class="test-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/testi2.jpg" class="img-fluid" alt="/">
                                    </div>
                                    <div class="peopl">
                                        <h3>Jenna John</h3>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="testi-des">
                                    <div class="test-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/testi1.jpg" class="img-fluid" alt="/">
                                    </div>
                                    <div class="peopl">
                                        <h3>Theo Hall</h3>
                                        <p class="indentity">Washington</p>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                <div class="testi-des">
                                    <div class="test-img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/testi3.jpg" class="img-fluid" alt="/">
                                    </div>
                                    <div class="peopl">
                                        <h3>Linda Carini</h3>
                                        <p class="indentity">Washington</p>
            ...
            <div class="container">
                ...
                <div class="row main-contteam-32 mt-sm-5 pt-lg-2">
                    <div class="col-lg-3 col-6 team-main-19">
                        <div class="column-19">
                            <a href="#team"><img class="img-fluid" src="https://i.pinimg.com/564x/e4/ce/a7/e4cea79f929ce2d3bb7b005f97ef2ca4.jpg" alt=" "></a>
                        </div>
                    ...
                    <div class="col-lg-3 col-6 team-main-19">
                        <div class="column-19">
                            <a href="#team"><img class="img-fluid" src="https://i.pinimg.com/564x/19/a3/12/19a312d1bb7c6cfb01e05b294eb720d1.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                    ...
                    <div class="col-lg-3 col-6 team-main-19">
                        <div class="column-19">
                            <a href="#team"><img class="img-fluid" src="https://i.pinimg.com/564x/01/6f/97/016f970ff757ad431fac0c1b33beafc8.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
                    ...
                    <div class="col-lg-3 col-6 team-main-19">
                        <div class="column-19">
                            <a href="#team"><img class="img-fluid" src="https://i.pinimg.com/564x/a1/9e/cd/a19ecd20e859c142ea2134cec586883b.jpg" alt=" "></a>
                        </div>
                        <div class="right-team-9">
